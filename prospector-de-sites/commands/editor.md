...
5. Se o usuário disser que terminou a edição e enviar/salvar o arquivo exportado, substitua `sites/[slug]/[slug].html` pelo conteúdo exportado. Se a página já estava publicada, rode `/publicar [cliente]` de novo para enviar a atualização ao repositório do GitHub — a Vercel republica automaticamente a cada push.
